...
train_input=np.zeros(shape=(number_of_data,number_of_matrix,number_of_line,number_of_column), dtype=int, order='F')
train_output=np.zeros(shape=(number_of_data,1,number_of_line,number_of_column), dtype=int, order='F')
parser("C:/Users/Roland/Desktop/Donnees_Demineur_5_31_train_input_5000.txt",number_of_matrix,train_input)
parser("C:/Users/Roland/Desktop/Donnees_Demineur_5_31_train_output_5000.txt",0,train_output)

test_input=np.zeros(shape=(number_of_test,number_of_matrix,number_of_line,number_of_column), dtype=int, order='F')
test_output=np.zeros(shape=(number_of_test,1,number_of_line,number_of_column), dtype=int, order='F')
parser("C:/Users/Roland/Desktop/Donnees_Demineur_5_31_test_input_5000.txt",number_of_matrix,test_input)
parser("C:/Users/Roland/Desktop/Donnees_Demineur_5_31_test_output_5000.txt",0,test_output)
...
model = tf.keras.models.Sequential([
  tf.keras.layers.Convolution2D(300,(3, 3),activation=tf.nn.relu,padding='same',data_format='channels_first'),
  tf.keras.layers.Convolution2D(300,(1, 1),activation=tf.nn.relu,padding='same',data_format='channels_first'),
  tf.keras.layers.Dropout(0.5),
  tf.keras.layers.Convolution2D(300,(3, 3),activation=tf.nn.relu,padding='same',data_format='channels_first'),
  tf.keras.layers.Convolution2D(300,1,activation=tf.nn.relu,padding='same',data_format='channels_first'),
  tf.keras.layers.Dropout(0.5),
  tf.keras.layers.Convolution2D(300,(3, 3),activation=tf.nn.relu,padding='same',data_format='channels_first'),
  tf.keras.layers.Convolution2D(300,1,activation=tf.nn.relu,padding='same',data_format='channels_first'),
  tf.keras.layers.Dropout(0.5),
